...
antijoin, there are 8 “Joanne” on the results but not on the bakers
sheet; and there are 8 “Jo” on the bakes but not results sheet. I
compared between the two names and found that they appear in the same
seasons and episodes! Therefore, I think that they are the same person.
I changed “Joanne” to “Jo” in that case.

There are names in bakers that not appearing in the bakes, names in
bakers that not appearing in the results, or names in the results not
appearing in the bakers, etc. Next, I performed left join first on
results with bakers, and next join with bakes.
