...
I also found that in "bakes", some bakers are names "Jo" with the quotation marks, so I remove it in the bakes document. When I did antijoin, there are 8 "Joanne" on the results but not on the bakers sheet; and there are 8 "Jo" on the bakes but not results sheet. I compared between the two names and found that they appear in the same seasons and episodes! Therefore, I think that they are the same person. I changed "Joanne" to "Jo" in that case. 
